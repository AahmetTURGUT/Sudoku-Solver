...
import static sudoku.ThreadC.CLOSED_CELL_TEXT;
...
public class ThreadD implements Runnable {
    ...
    private String ad;
    static String GrafikAdiD = " ";
    public static Color CLOSED_CELL_TEXT;

    public ThreadD(String ad) {
        this.ad = ad;
    }
    ...
    public void run() {
       ...
       ii = generator.nextInt(800);
        ...
        if (cozum(i, j, tahta, 0, randDeger) && Main.bittiMi != true) {
            ...
            GrafikAdiD = "Board D=" + (end - start) + " MS DE BULDU";
        ...
        for (i = 0; i < 9; i++) {
            ...
            for (j = 0; j < 9; j++) {
                ...
                if (TahtadanYazdir[i][j] == 0) {
                    ...
                    GrafikD.puzzle[i][j] = TahtadanYazdir[i][j];
                }
            }
            System.out.println("|");
        }
